<template>
 <div class="wrapper pa-w-full pa-my-24">
   <section class="container pa-p-5 pa-mx-auto pa-w-full pa-flex pa-flex-wrap pa-justify-center pa-items-center md:pa-w-full">
     <div class="content pa-flex pa-flex-col pa-flex-wrap pa-w-full pa-justify-center pa-items-center">
       <!-- nav -->
       <div class="pa-w-full">
       <ul class="nav-ul pa-p-4 pa-w-full pa-flex pa-flex-wrap pa-justify-evenly  pa-items-center pa-bg-black  pa-rounded-md pa-font-bold">     
